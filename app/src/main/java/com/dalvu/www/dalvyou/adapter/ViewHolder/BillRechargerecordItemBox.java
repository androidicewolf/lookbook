...
public class BillRechargerecordItemBox extends RecyclerView.ViewHolder {
    ...
    public TextView rechargerecord_xrecycleritem_passingstate;
    ...
    public BillRechargerecordItemBox(View itemView) {
        ...
        rechargerecord_xrecycleritem_passingstate = (TextView) itemView.findViewById(R.id.rechargerecord_xrecycleritem_passingstate);
