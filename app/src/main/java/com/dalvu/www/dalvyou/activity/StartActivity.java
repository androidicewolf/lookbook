...
public class StartActivity extends Activity {
    ...
    private void login() {
        //从本地取出账号的token
        final String uid = SharedPreferencesTool.getString(this, CustomValue.UID, "");
        String token = SharedPreferencesTool.getString(this, CustomValue.TOKEN, "");
        ...
        if (!uid.isEmpty() && !token.isEmpty() && !user_type.isEmpty()) {
            ...
            OnResponseListener<String> responseListener = new OnResponseListener<String>() {
                ...
                public void onSucceed(int what, Response<String> response) {
                    ...
                    switch (what) {
                        case 0:
                            ...
                            UserInfoBean userInfoBeanAd = MyApplication.getGson().fromJson(jsonAd, UserInfoBean.class);
                        ...
                        case 1:
                            ...
                            UserInfoBean userInfoBeanVi = MyApplication.getGson().fromJson(jsonVi, UserInfoBean.class);
                ...
                public void onFailed(int what, Response<String> response) {
                    Log.e("call", "请求网络失败，isGoin被赋值为TRUE");
                    nextIntent = new Intent(StartActivity.this, StatusActivity.class);
                    startNext();
